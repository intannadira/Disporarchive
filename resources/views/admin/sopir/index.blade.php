                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 col-12">
                                <h4 class="header-title">Data Sopir</h4>
                            </div>
                            <div class="col-md-6 col-12">
...
<script type="text/javascript">
    ...
    function add(){
      ...
      $('.modal-title').text('Tambah Data Sopir'); // Set Title to Bootstrap modal title
    }
    ...
    function edit(id){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('.modal-title').text('Edit Data Sopir'); // Set title to Bootstrap modal title   
            },
            error: function (jqXHR, textStatus , errorThrown) {
                alert(errorThrown);
            }
