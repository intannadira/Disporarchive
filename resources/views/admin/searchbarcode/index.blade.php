                ...
                <div class="card mt-4">
                    <div class="card-body">
                        <div class="text-center">
                            <h4>CARI BARCODE ANDA DISINI</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#dataTable').DataTable({
            ...
            ajax: {
                  url: "{{ route('admin.searchbarcode.index') }}",
                  type: "GET",
                  data: function(data) {
                    data.from       = $('#from').val();
                    data.to         = $('#to').val();
            ...
            columns: [
                ...
                {data: 'status_transaksi', name: 'status_transaksi', searchable: false},
                {data: 'transaksi.sopir.nama', name: 'transaksi.sopir.nama', searchable: false},
                {data: 'transaksi.relasi.nama_relasi', name: 'transaksi.relasi.nama_relasi', searchable: false},
                {data: 'id_barcode', name: 'id_barcode'},
            ],
        });
